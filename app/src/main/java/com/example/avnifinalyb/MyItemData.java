...
public class MyItemData {
    ...
    public MyItemData() {
            ...
            data.put("China", new MyItem("China", "Asia", "Atheist", "No", "No", "1.4B"));
            ...
            data.put("Japan", new MyItem("Japan", "Asia", "Buddhism", "No", "No", "125M"));
            data.put("Jordan", new MyItem("Jordan", "Asia", "Islam", "No", "Yes", "10M"));
            data.put("Kazakhstan", new MyItem("Kazakhstan", "Asia", "Islam", "Yes", "No", "19M"));
            ...
            data.put("Lebanon", new MyItem("Lebanon", "Asia", "Islam", "No", "No", "6.8M"));
            ...
            data.put("Nepal", new MyItem("Nepal", "Asia", "Hinduism", "Yes", "No", "29M"));
            data.put("North Korea", new MyItem("North Korea", "Asia", "Atheist", "Yes", "No", "25M"));
            ...
            data.put("Singapore", new MyItem("Singapore", "Asia", "Buddhism", "No", "No", "5.7M"));
            data.put("South Korea", new MyItem("South Korea", "Asia", "Christianity", "No", "No", "51M"));
            data.put("Sri Lanka", new MyItem("Sri Lanka", "Asia", "Buddhism", "No", "No", "21M"));
            data.put("Syria", new MyItem("Syria", "Asia", "Islam", "No", "No", "17M"));
            ...
            data.put("Vietnam", new MyItem("Vietnam", "Asia", "Buddhism", "No", "No", "96M"));
            data.put("Yemen", new MyItem("Yemen", "Asia", "Islam", "No", "No", "30M"));

            // --- EUROPE ---
            data.put("Albania", new MyItem("Albania", "Europe", "Islam", "No", "No", "2.8M"));
            ...
            data.put("Belgium", new MyItem("Belgium", "Europe", "Christianity", "No", "No", "11.6M"));
            data.put("Bosnia and Herzegovina", new MyItem("Bosnia and Herzegovina", "Europe", "Islam", "No", "No", "3.3M"));
            ...
            data.put("Cyprus", new MyItem("Cyprus", "Europe", "Christianity", "No", "No", "1.2M"));
            data.put("Czech Republic", new MyItem("Czech Republic", "Europe", "Atheist", "No", "No", "10.7M"));
            data.put("Denmark", new MyItem("Denmark", "Europe", "Christianity", "No", "No", "5.8M"));
            data.put("Estonia", new MyItem("Estonia", "Europe", "Atheist", "No", "No", "1.3M"));
            data.put("Finland", new MyItem("Finland", "Europe", "Christianity", "No", "No", "5.5M"));
            data.put("France", new MyItem("France", "Europe", "Christianity", "No", "Yes", "67M"));
            data.put("Germany", new MyItem("Germany", "Europe", "Christianity", "No", "Yes", "83M"));
            ...
            data.put("Kosovo", new MyItem("Kosovo", "Europe", "Islam", "No", "No", "1.8M"));
            data.put("Latvia", new MyItem("Latvia", "Europe", "Christianity", "No", "No", "1.9M"));
            ...
            data.put("Montenegro", new MyItem("Montenegro", "Europe", "Christianity", "No", "No", "0.62M"));
            data.put("Netherlands", new MyItem("Netherlands", "Europe", "Christianity", "No", "No", "17M"));
            data.put("North Macedonia", new MyItem("North Macedonia", "Europe", "Christianity", "No", "No", "2.1M"));
            ...
            data.put("Russia", new MyItem("Russia", "Europe / Asia", "Christianity", "Yes", "No", "144M"));
            ...
            data.put("Sweden", new MyItem("Sweden", "Europe", "Christianity", "No", "No", "10M"));
            data.put("Switzerland", new MyItem("Switzerland", "Europe", "Christianity", "No", "Yes", "8.6M"));
            data.put("Ukraine", new MyItem("Ukraine", "Europe", "Christianity", "No", "No", "41M"));
            data.put("United Kingdom", new MyItem("United Kingdom", "Europe", "Christianity", "No", "No", "67M"));
            data.put("Vatican City", new MyItem("Vatican City", "Europe", "Christianity", "No", "No", "0.0008M"));

            // --- NORTH AMERICA ---
            data.put("Canada", new MyItem("Canada", "North America", "Christianity", "No", "No", "38M"));
            data.put("United States", new MyItem("United States", "North America", "Christianity", "No", "Yes", "331M"));
            ...
            data.put("Cuba", new MyItem("Cuba", "North America", "Christianity", "No", "No", "11M"));
            data.put("Dominican Republic", new MyItem("Dominican Republic", "North America", "Christianity", "No", "No", "10.8M"));
            data.put("Haiti", new MyItem("Haiti", "North America", "Christianity", "No", "No", "11M"));
            ...
            data.put("Trinidad and Tobago", new MyItem("Trinidad and Tobago", "North America", "Christianity", "No", "No", "1.4M"));
            ...
            data.put("Bolivia", new MyItem("Bolivia", "South America", "Christianity", "Yes", "No", "11.8M"));
            ...
            data.put("Guyana", new MyItem("Guyana", "South America", "Christianity", "No", "No", "0.79M"));
            data.put("Paraguay", new MyItem("Paraguay", "South America", "Christianity", "No", "No", "7M"));
            data.put("Peru", new MyItem("Peru", "South America", "Christianity", "No", "No", "33M"));
            data.put("Suriname", new MyItem("Suriname", "South America", "Christianity", "No", "No", "0.6M"));
